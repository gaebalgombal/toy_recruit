...
-- companies
INSERT INTO companies (type_sub_industry_id, name, image_thumbnail, net_sales)
VALUES
    ((SELECT id FROM type_sub_industries WHERE sub_industry = "플랫폼"), "네이버", "image_thumbnail.jpg", 1000),
    ((SELECT id FROM type_sub_industries WHERE sub_industry = "플랫폼"), "카카오", "image_thumbnail.jpg", 1000),
    ((SELECT id FROM type_sub_industries WHERE sub_industry = "이커머스"), "쿠팡", "image_thumbnail.jpg", 1000),
    ((SELECT id FROM type_sub_industries WHERE sub_industry = "이커머스"), "넥슨", "image_thumbnail.jpg", 1000);
