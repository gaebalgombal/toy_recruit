...
--     businesstype_id INT,
--     CONSTRAINT fk_businesstypes__companies FOREIGN KEY (businesstype_id) REFERENCES businesstypes(id) ON DELETE CASCADE,
...
-- -- jobs__companies
-- CREATE TABLE jobs__companies(
--     id INT NOT NULL UNIQUE AUTO_INCREMENT,
--     PRIMARY KEY (id),
--     company_id INT NOT NULL,
--     CONSTRAINT fk_companies__jobs FOREIGN KEY (company_id) REFERENCES companies(id) ON DELETE CASCADE,
--     job_id INT NOT NULL,
--     CONSTRAINT fk_jobs__companies FOREIGN KEY (job_id) REFERENCES jobs(id) ON DELETE CASCADE,
--     create_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
--     update_at DATETIME ON UPDATE CURRENT_TIMESTAMP,
--     delete_at DATETIME,
--     is_deleted BOOLEAN NOT NULL DEFAULT FALSE   
